...
public class Receiver extends BroadcastReceiver {
    ...
    SoundPool soundPool;
    int krik;
    RemoteViews notificationLayout = new RemoteViews("by.ddrvld.countdowndeathapp", R.layout.toolbar);
    RemoteViews notificationLayoutExpanded = new RemoteViews("by.ddrvld.countdowndeathapp", R.layout.rating_app);
